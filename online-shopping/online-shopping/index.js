    ...
    .then(data => {
        ...
        if (data.code === 1) {
            ...
            switch (data.data.role) {
                case 'User':
                    globalThis.userId = data.data.id;
                    window.location.href = 'http://localhost:63343/untitled2/E-commerce-platform/online-shopping/online-shopping/user_dashboard.html'; // 用户跳转页面
                    break;
                case 'Admin':
                    globalThis.merchantId = data.data.id;
                    window.location.href = 'http://localhost:63343/untitled2/E-commerce-platform/online-shopping/online-shopping/merchant_dashboard.html'; // 商家跳转页面
                    break;
                case 'admin':
